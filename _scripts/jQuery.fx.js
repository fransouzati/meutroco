...
jQuery.fn.hashEnable = function(){
	...
	var views = [
		...
		['#marcadores', viewsPath+'tags/tags.php', 'normal', 'Marcadores'],
		['#editarMarcadores', viewsPath+'tags/editTags.php', 'normal', 'Editar marcadores'],
		['#verMarcador', viewsPath+'tags/viewTag.php', 'normal', 'Ver marcador'],
