...
//Diretório da API
TEST_SERVER ? define('API_PATH', 'http://127.0.0.1:8888/api.meutroco.com.br') : define('API_PATH', 'http://api.meutroco.com.br');
...
//Diretório do site
TEST_SERVER ? define('SITE_URL','http://127.0.0.1:8888/meutroco.com.br') : define('SITE_URL','http://www.meutroco.com.br');
